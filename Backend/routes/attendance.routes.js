...
// Student routes
router.post('/check-in/:code', auth, roleCheck('student', 'admin'), attendanceController.checkIn);
router.post('/events/:eventId/check-out', auth, roleCheck('student'), attendanceController.checkOut);
router.get('/my-history', auth, roleCheck('student', 'admin'), attendanceController.getUserAttendance);
